...
public final class MemoryCacheUtil {
    ...
    private static final String ROUND_SEPARATOR = "r";
    ...
    public static String generateKey(String imageUri, ImageSize targetSize) {
        return new StringBuilder(imageUri).append(URI_AND_SIZE_SEPARATOR).append(targetSize.getWidth()).append(WIDTH_AND_HEIGHT_SEPARATOR).append(targetSize.getHeight()).append(ROUND_SEPARATOR).append(targetSize.getRound()).toString();
    }
