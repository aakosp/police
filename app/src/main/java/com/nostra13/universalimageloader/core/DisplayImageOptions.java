...
public final class DisplayImageOptions {
    ...
    private DisplayImageOptions(Builder builder) {
        ...
        round = builder.round;
        defaultbitmap = builder.defaultbitmap;
    ...
    public int showRoundCorners() {
        return round;
    }

    public boolean showDefaultBitmap() {
        return null != defaultbitmap;
    }
    ...
    public static class Builder {
        ...
        // 添加圆角属性
        public Builder roundCorners(int round) {
            this.round = round;
            return this;
        }

        public Builder showDefault(Bitmap defaultbitmap) {
        ...
        public Builder cloneFrom(DisplayImageOptions options) {
            ...
            round = options.round;
            defaultbitmap = options.defaultbitmap;
